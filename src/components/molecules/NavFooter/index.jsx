...
function NavFooter({setShowFooter}) {
  return (
    <nav className="dropdown-menu lg:hidden">
            <div className="dropdown-links">
                <div className="bar" onClick={()=>setShowFooter(false)}></div>
                <div className="dropdown-items ">
                    <a href="/" className="flex">
                        <div style={{height:"50px",  width:"50px"}}>
                            <Image style={{height:"40px", width:"40px"}} src={brand} alt=""/>
                        </div>
                        <div>
                ...
                <div className="dropdown-items ">
                    <a href="./routes/theginuwa.html" className="flex">
                ...
                <div className="dropdown-items ">
                    <a href="./warritraditionalcouncil.html" className="flex">
                ...
                <div className="dropdown-items ">
                    <a href="./royalcourtnotices.html" className="flex">
